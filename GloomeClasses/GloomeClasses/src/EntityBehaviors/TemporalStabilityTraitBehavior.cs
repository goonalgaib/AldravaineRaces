...
namespace AldravaineRaces.src.EntityBehaviors {
    public class TemporalStabilityTraitBehavior : EntityBehavior {
        ...
        public bool hasNervesofsteel = false;
        ...
        public const string Nervesofsteelcode = "nervesofsteel";
            ...
            if (timeSinceLastUpdate > 1.0f) { //Only tick once a second or so, this doesn't need to run EVERY tick, that would be incredibly excessive.
                ...
                if (!hasLocatedClass) {
                    ...
                    if (charclass != null) {
                        ...
                        if (charclass.Traits.Contains(Nervesofsteelcode)) {
                            hasNervesofsteel = true;
                        }
